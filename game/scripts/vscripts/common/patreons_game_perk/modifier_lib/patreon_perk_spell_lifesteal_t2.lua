patreon_perk_spell_lifesteal_t2 = class({})
--------------------------------------------------------------------------------

function patreon_perk_spell_lifesteal_t2:IsHidden()
	return false
end

--------------------------------------------------------------------------------
function patreon_perk_spell_lifesteal_t2:GetTexture()
	return "perkIcons/patreon_perk_spell_lifesteal_t0"
end

--------------------------------------------------------------------------------
function patreon_perk_spell_lifesteal_t2:IsPurgable()
	return false
end
--------------------------------------------------------------------------------
function patreon_perk_spell_lifesteal_t2:RemoveOnDeath()
	return false
end
--------------------------------------------------------------------------------

function patreon_perk_spell_lifesteal_t2:DeclareFunctions()
	local funcs = {
