patreon_perk_spell_lifesteal_t0 = class({})
--------------------------------------------------------------------------------

function patreon_perk_spell_lifesteal_t0:IsHidden()
	return false
end

--------------------------------------------------------------------------------
function patreon_perk_spell_lifesteal_t0:GetTexture()
	return "perkIcons/patreon_perk_spell_lifesteal_t0"
end

--------------------------------------------------------------------------------
function patreon_perk_spell_lifesteal_t0:IsPurgable()
	return false
end
--------------------------------------------------------------------------------
function patreon_perk_spell_lifesteal_t0:RemoveOnDeath()
	return false
end
--------------------------------------------------------------------------------

function patreon_perk_spell_lifesteal_t0:DeclareFunctions()
	local funcs = {
